...
// nativeBoolToBooleanObject Return a reference to boolean object to reduce number created
...
// applyFunction Create a new outer environment when evaluating a function
